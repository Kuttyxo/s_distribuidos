...
from policies.fifo import FIFOCache  # Cambiado de LRUCache a FIFOCache
...
UNIFORM_CACHE = FIFOCache(max_bytes=int(os.getenv('UNIFORM_CACHE_BYTES', 25600)))  # 100KB
NORMAL_CACHE = LFUCache(max_bytes=int(os.getenv('NORMAL_CACHE_BYTES', 180000)))    # 50KB
...
def handle_uniform():
    ...
    if action == 'get':
        ...
        return jsonify({
            ...
            'cache': 'FIFO',  # Actualizado de 'LRU' a 'FIFO'
